...
const roomType = 'люкс';
let message =  `${name} пребывает на отдых ${date} в ${roomType}`;
console.log(message);*/
...
const inputPassword = prompt('Введите пароль доступа');
...
if(country !== null ){
    switch(country){
        ...
        break;
        default:
        alert('There is no service in your country');
    }
}*/
...
/*let funny = 'happy';
const inputUser = prompt('enter your name');
inputUser === 'Maksim'? funny ='cry': funny = 'laugh';
console.log(funny);*/
